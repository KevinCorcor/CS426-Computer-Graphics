...
namespace OpenGL_Models_SS 
{
	...
	private: System::Windows::Forms::Label^  label_Proj_Mod;

	private: System::Windows::Forms::Label^  label_Proj_Mat;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label_Proj_Mod = (gcnew System::Windows::Forms::Label());
			this->label_Proj_Mat = (gcnew System::Windows::Forms::Label());
			this->trackBar_rotation = (gcnew System::Windows::Forms::TrackBar());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->trackBar_rotation))->BeginInit();
			this->SuspendLayout();
			// 
			// timer1
			// 
			...
			// trackBar_Radius
			// 
			this->trackBar_Radius->Location = System::Drawing::Point(673, 12);
			...
			this->trackBar_Radius->Size = System::Drawing::Size(45, 452);
			...
			this->label_Radius->Location = System::Drawing::Point(670, 467);
			...
			// trackBar_Latitude
			// 
			this->trackBar_Latitude->Location = System::Drawing::Point(733, 12);
			...
			this->trackBar_Latitude->Size = System::Drawing::Size(45, 452);
			...
			this->label_Latitude->Location = System::Drawing::Point(730, 467);
			...
			// label_Proj_Mod
			// 
			this->label_Proj_Mod->AutoSize = true;
			this->label_Proj_Mod->Location = System::Drawing::Point(784, 222);
			this->label_Proj_Mod->Name = L"label_Proj_Mod";
			this->label_Proj_Mod->Size = System::Drawing::Size(67, 13);
			this->label_Proj_Mod->TabIndex = 7;
			this->label_Proj_Mod->Text = L"Model Matrix";
			// 
			// label_Proj_Mat
			// 
			this->label_Proj_Mat->AutoSize = true;
			this->label_Proj_Mat->Location = System::Drawing::Point(784, 43);
			this->label_Proj_Mat->Name = L"label_Proj_Mat";
			this->label_Proj_Mat->Size = System::Drawing::Size(85, 13);
			this->label_Proj_Mat->TabIndex = 8;
			this->label_Proj_Mat->Text = L"Projection Matrix";
			// 
			// trackBar_rotation
			// 
			this->trackBar_rotation->Location = System::Drawing::Point(673, 520);
			this->trackBar_rotation->Name = L"trackBar_rotation";
			this->trackBar_rotation->Size = System::Drawing::Size(251, 45);
			this->trackBar_rotation->TabIndex = 0;
			this->trackBar_rotation->TabStop = false;
			this->trackBar_rotation->Value = 1;
			this->trackBar_rotation->ValueChanged += gcnew System::EventHandler(this, &Form1::trackBar_rotation_ValueChanged);
			// 
			// label_speed
			// 
			this->label_speed->AutoSize = true;
			this->label_speed->Location = System::Drawing::Point(807, 552);
			this->label_speed->Name = L"label_speed";
			this->label_speed->Size = System::Drawing::Size(41, 13);
			this->label_speed->TabIndex = 10;
			this->label_speed->Text = L"Speed:";
			// 
			// Form1
			// 
			...
			this->Controls->Add(this->label_Proj_Mat);
			this->Controls->Add(this->label_Proj_Mod);
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->trackBar_rotation))->EndInit();
...
#pragma endregion
		private: System::Void Form1_Load(System::Object^  sender, System::EventArgs^  e) 
		{
			...
			label_speed->Text = "Speed: "+System::Convert::ToString(trackBar_rotation->Value);
		}
		private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e) 
		{
			 //not both
			//OpenGL->longitude+=0.025;
			OpenGL->rotation+=trackBar_rotation->Value;
			OpenGL->Render();
			glm::mat4 p;
		...
		private: System::Void trackBar_rotation_ValueChanged(System::Object^  sender, System::EventArgs^  e) 
		{
